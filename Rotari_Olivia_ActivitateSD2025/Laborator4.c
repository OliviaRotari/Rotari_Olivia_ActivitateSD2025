...
//}
//
//Nod* citireListaMasiniDinFisier(const char* numeFisier) { //am schimbat din void in Nod*
//
//
...
//	if (f) {
//		while (!feof(f)) {
//			//creare lista cu inserare la sfarsit
...
//
//int main() {
//	Nod* cap = citireListaMasiniDinFisier("masini1.txt");
