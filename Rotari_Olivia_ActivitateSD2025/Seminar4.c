...
int main() {
	...
	Nod* masini = citireListaMasiniDinFisier("masini1.txt");
	afisareListaMasini(masini);
	printf("========Pret mediu=======");
	printf(".2%f\n", calculeazaPretMediu(masini));
	printf("========Pret masini sofer=======");
	printf("suma masinilor lui Inescu: %.2f", calculeazaPretulMasinilorUnuiSofer(masini, "Ionescu"));
